module BootstrapForms
  class FormBuilder < ::ActionView::Helpers::FormBuilder
    ...
    def error_messages
      if object.try(:errors) and object.errors.full_messages.any?
        content_tag(:div, :class => 'alert alert-block alert-error validation-errors') do
          content_tag(:h4, I18n.t('bootstrap_forms.errors.header', :count => object.errors.size, :model => object.class.model_name.human), :class => 'alert-heading') +
          content_tag(:ul) do
    ...
    def cancel(*args)
      ...
      link_to(I18n.t('bootstrap_forms.buttons.cancel', :default => 'Cancel'), (@field_options[:back] || :back), @field_options.except(:back))
    end
